...
CALLBACK_URL = 'http://gengxinji.acg.moe/code'
...
authheaders = {'User-Agent': user_agent, 'host': 'api.weibo.com', 'method': 'POST',
               'content-type': 'application/x-www-form-urlencoded', 'origin': 'https://api.weibo.com'}
...
def post(status, pic):
    ...
    requesturl = 'https://api.weibo.com/2/short_url/shorten.json?access_token=' + \
        r.get('access_token') + '&url_long=http://zh.moegirl.org/' + urllib.quote(status)
